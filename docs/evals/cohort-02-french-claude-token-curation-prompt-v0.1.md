...
2. Save the raw Claude JSON output locally.
3. Manually review and trim to 10 tokens per bucket.
4. Produce a separate reviewed-token JSON task.
5. Only then run `/evals`.
