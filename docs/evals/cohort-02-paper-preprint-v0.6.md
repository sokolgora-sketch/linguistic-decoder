...
Version: v0.6
Date: 2026-05-11
Document type: Technical report / preprint
...
Publication status: Evidence archive published on Zenodo; prepared for LingBuzz preprint submission.
...
13. The evidence archive is public on Zenodo.
...
The Cohort 02 evidence archive is published on Zenodo as:
