...
describe("Comparative Spectrogram v0.1 — Corpus70 vs Classical100 (and Latin/Greek split)", () => {
  it("writes tests/validation/out/spectrogram.v0.1.md", () => {
    const root = process.cwd();
    const outDir = path.join(root, "tests/validation/out");
    const outMd = path.join(outDir, "spectrogram.v0.1.md");
    ...
    const lines: string[] = [];
    lines.push("# Comparative Spectrogram v0.1 — Tag ↔ Carrier Fingerprints");
    lines.push("");
