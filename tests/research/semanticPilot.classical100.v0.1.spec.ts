...
describe("Semantic Pilot Classical100 v0.1 — tag ↔ vowel association (Latin+Greek, IPA required)", () => {
  it("writes tests/validation/out/semanticPilot.classical100.v0.1.md", () => {
    ...
    const outMd = path.join(outDir, "semanticPilot.classical100.v0.1.md");
    ...
    const lines: string[] = [];
    lines.push("# Semantic Pilot Classical100 v0.1 — Tag ↔ Vowel Purity (Latin+Greek)");
    lines.push("");
    lines.push(`- corpus: Classical100 (100)`);
