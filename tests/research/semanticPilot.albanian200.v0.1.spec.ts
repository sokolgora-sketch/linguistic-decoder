...
describe("Semantic Pilot Albanian200 v0.1 — tag ↔ vowel association (Albanian (sq), IPA required)", () => {
  it("writes tests/validation/out/semanticPilot.albanian200.v0.1.md", () => {
    ...
    const outMd = path.join(outDir, "semanticPilot.albanian200.v0.1.md");
...
const meta = readJson<Meta>(metaPath);
    ...
    const lines: string[] = [];
    lines.push("# Semantic Pilot Albanian200 v0.1 — Tag ↔ Vowel Purity (Albanian (sq))");
    lines.push("");
