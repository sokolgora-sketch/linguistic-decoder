...
describe("Tag Audit Albanian200 v0.1 — tag pollution + carrier distributions", () => {
  it("writes tests/validation/out/tagAudit.albanian200.v0.1.md", () => {
    ...
    const outMd = path.join(outDir, "tagAudit.albanian200.v0.1.md");
