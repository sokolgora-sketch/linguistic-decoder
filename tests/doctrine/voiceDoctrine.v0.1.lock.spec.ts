...
test("voice doctrine v0.1 — snapshot lock (full export surface)", () => {
  expect({
    VOICES_V0_1,
    COLORS_BY_VOICE_V0_1,
    COLORS_HEX_BY_VOICE_V0_1,
...
test("voice doctrine v0.1 — invariants", () => {
  ...
  expect(keysSorted(COLORS_HEX_BY_VOICE_V0_1 as any)).toEqual(voiceKeys);
  expect(keysSorted(LABELS_BY_VOICE_V0_1 as any)).toEqual(voiceKeys);
  expect(keysSorted(NOTES_BY_VOICE_V0_1 as any)).toEqual(voiceKeys);
  expect(keysSorted(NOTES_ABC_BY_VOICE_V0_1 as any)).toEqual(voiceKeys);
