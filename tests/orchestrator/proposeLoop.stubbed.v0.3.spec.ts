          ...
          rawText: JSON.stringify(
            {
              ...
              mode: "strict",
              candidates: [
                { form: "study", language: "English", opsUsed: ["OP_NOT_REAL___ILLEGAL"], decomposition: { action: "study", statement: "study x" } },
              ],
            },
            null,
            2
        ...
        rawText: JSON.stringify(
          {
            word: "study",
            mode: "strict",
            candidates: [{ form: "study", language: "English", opsUsed: [], decomposition: { action: "study", statement: "study ok" } }],
          },
          null,
          2
        ),
