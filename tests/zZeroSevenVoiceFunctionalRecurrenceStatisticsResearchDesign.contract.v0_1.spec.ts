      ...
      () => {
        ...
        for (
          ...
          of [
            ...
            "the methodology must preregister and freeze either a reproducible random seed, a deterministic random-stream derivation, or an exhaustive computation rule before any evidence from the applicable confirmatory dataset is examined",
            ...
            "The methodology must also preregister how Monte Carlo or simulation error near the confirmatory decision boundary is handled",
            ...
            "A study-level adequacy result for one primary endpoint must not automatically authorize confirmatory inference for rarer secondary voices, subgroups, concepts, comparison modes, or other endpoints",
            ...
            "Post-hoc weakening or replacement of the target power, effect-size assumption, precision target, uncertainty-width target, endpoint-specific adequacy requirement, or other adequacy criterion after confirmatory evidence has been examined must remain explicitly exploratory",
      ...
      () => {
        ...
        for (
          ...
          of [
            ...
            "every confirmatory attempt must remain registered and auditable, including unsuccessful, inconclusive, blocked, and completed attempts",
            "the methodology must preregister and freeze the rule governing confirmatory interpretation across repeated datasets",
            ...
            "A newly collected confirmatory dataset must not silently reset the confirmatory error budget",
            "Selective continuation, stopping, omission, or reporting of confirmatory datasets based on observed results is prohibited.",
            "If repeated confirmatory datasets exist without a preregistered applicable across-dataset rule, the additional attempts must remain exploratory",
