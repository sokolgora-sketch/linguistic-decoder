      ...
      () => {
        ...
        for (
          ...
          of [
            ...
            "the complete inferential decision rule must also be preregistered and frozen before holdout evidence is examined",
            "the significance level or alpha",
            "the test sidedness where applicable",
            "the exact rejection or confirmatory decision criterion",
            "the analogous reviewed decision threshold or decision rule must be preregistered and frozen before holdout evidence is examined",
