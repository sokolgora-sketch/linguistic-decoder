...
import { computeDeepRoot } from "./zero-engine-deep-root";

describe("ZË-RO DeepRoot – canon words", () => {
  it("damage / dëmtim → DA-MA-GJE", () => {
    const damage = computeDeepRoot("damage");
    const demtim = computeDeepRoot("dëmtim");
  ...
  it("language → LAN-GUA-GJE", () => {
    const res = computeDeepRoot("language");
