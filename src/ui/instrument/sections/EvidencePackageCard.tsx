  ...
  return (
    <div className="rounded-xl border border-slate-700/80 bg-[#10151c] p-4 shadow-[0_16px_48px_rgba(0,0,0,0.28)]">
      ...
      <div className="mt-1 text-xs text-slate-500">
        VM-only export bundle for sharing and audit. Summary is readable; package is JSON.
      </div>

      <div className="mt-2 flex flex-wrap gap-2">
        <button
          type="button"
          className="rounded-md border border-emerald-400/50 bg-emerald-500/10 px-3 py-1.5 text-sm font-semibold text-emerald-100 transition hover:border-emerald-300 hover:bg-emerald-500/20"
