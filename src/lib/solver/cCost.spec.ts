...
import { computeC } from "./valueTables";

// We pass voice paths and the consonant class per hop directly.
// Cast to any to avoid importing your Vowel/CClass types here.
