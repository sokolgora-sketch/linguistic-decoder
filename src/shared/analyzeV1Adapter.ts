...
function adaptCandidate(rawCandidate: RawCandidate): CandidateUI {
  ...
  const embryoFirstCandidateFields = {
    ...
    semanticAlignmentStatus: optionalString(rawCandidate?.semanticAlignmentStatus),
    semanticAlignmentSource: optionalString(rawCandidate?.semanticAlignmentSource),
    semanticAlignmentReasonCodes: optionalStringArray(rawCandidate?.semanticAlignmentReasonCodes),
    semanticAlignmentBridge: optionalStringOrNull(rawCandidate?.semanticAlignmentBridge),
