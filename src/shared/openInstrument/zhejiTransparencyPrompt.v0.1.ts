...
export function buildZhejiPromptContractSectionV0_1(
  ...
  return {
    ...
    section: [
      ...
      "Every non-null chunkCandidates[] object must include non-empty language, candidateForm, meaning, and sourceNote.",
      ...
      `Every chunkCandidates[].segmentationId must exactly equal ${input.segmentationId}.`,
      "Every nullCandidates[] object must include segmentationId.",
      `Every nullCandidates[].segmentationId must exactly equal ${input.segmentationId}.`,
