...
export default function Page() {
  ...
  const analysis = result ? enginePayloadToAnalysisResult(result as any) : null;
...
{analysis && <WordMatrixCard matrix={(analysis as any).wordMatrix ?? null} />}
{analysis && (
<Card>
  <CardHeader>
        ...
        {showDebug && analysis && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Full JSON from the analysis object, including `deepRoot` and `wordMatrix`.
              </CardDescription>
            </CardHeader>
            <CardContent>
